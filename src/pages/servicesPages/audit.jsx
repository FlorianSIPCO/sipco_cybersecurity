...
export default function AuditPage() {
    ...
    return (
        <ServiceDetailLayout title="Audit & Diagnostic de sécurité" current="/services/audit">
            <p>
                L’audit de cybersécurité constitue la première étape essentielle dans la protection de votre système d’information. Chez SIPCO, nous réalisons une évaluation complète et rigoureuse de votre architecture numérique afin d’identifier les failles, vulnérabilités et risques potentiels. Notre méthodologie est conforme aux standards de l’ANSSI et intègre les dernières recommandations du secteur.
            </p>
            ...
            <p>
                Notre expertise repose sur plus de 40 ans d’expérience dans la sécurisation des systèmes d’information. En tant qu’acteur labellisé, nous assurons un audit neutre, indépendant et immédiatement exploitable par votre DSI ou prestataire IT.
            </p>
